...
local function getAvatarMaterial(steamid64, callback)
    ...
    http.Fetch("https://steamcommunity.com/profiles/" .. steamid64 .. "?xml=1",
        ...
        function(b, s, _, c)
            ...
            if s == 0 or c < 200 or c > 299 then return callback(fallback, steamid64) end

            local url, fileType = b:match("<avatarFull>.-(https?://%S+%f[%.]%.)(%w+).-</avatarFull>") -- Extract the URL and file extension from <avatarFull>
...
strider.thirdparty = strider.thirdparty or {}
strider.thirdparty.getAvatarMaterial = getAvatarMaterial