...
local PANEL = vgui.Register("strider:Resizable", {}, "DPanel")
...
function PANEL:PaintOver(w, h)
    ...
    strider.DrawImage("https://i.imgur.com/KRo8XD4.png", w - size - pad, h - size - pad, size, size)
end
...
-- strider.DebugPanel("strider:Resizable", function(p)
--     p:SetSize(400, 400)
--     p:Center()
